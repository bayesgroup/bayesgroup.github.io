<h2 align="center">Отборочное задание deepbayes.ru</h2> 
...
Здесь N число объектов в обучающей выборке, M число признаков описывающих объект, **w** вектор весов признаков, **X** матрица объекты-признаки, **y** вектор ответов на объектах обучающей выборки.

Используйте файл [ ```task.py```](https://bayesgroup.github.io/deepbayes-school/2017/task/task.py) как заготовку решения. Вам необходимо написать тело следующих функций:
