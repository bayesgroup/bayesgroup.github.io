...
Описание типов данных и размерностей аргументов приведено в (bayesgroup.github.io/deepbayes-school/2017/task/task.py заготовке решения). Язык для выполнения задания: _python 2.7_.
