...
Где N число объектов в обучающей выборке, M число признаков описывающих объект, **w** вектор весов признаков, **xi** i-ый объект обучающей  выборки, **y** $y_s$ ответ на i-м объекте.
