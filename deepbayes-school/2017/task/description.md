...
Где N число объектов в обучающей выборке, M число признаков описывающих объект, **w** вектор весов признаков, **x**_i i-ый объект обучающей  выборки, **y**_i ответ на i-м объекте.
