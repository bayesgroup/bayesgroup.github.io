...
Описание типов данных и размерностей аргументов приведено в заготовке решения [ref]. Язык для выполнения задания: _python 2.7_.
